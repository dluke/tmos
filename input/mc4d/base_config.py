...
# crawling mode
args.surface.initial_contact = True
...
# def setup_study():
#     var = np.array([0.5,1.0,2.0,4.0,8.0,12.0,20.0])
#     setup = ('pilivar', var)
#     return OrderedDict([setup])
...
# def pool(dry_run=False):
#     write_config()
#     # construct parameter dictionary
#     allparams = setup_study()

#     range_tfp.pretty_allparams(allparams)
#     import pili
#     pili.write_version(os.path.dirname(__file__))
#     maxcores = 24
#     pool = range_tfp.buildpool(args, allparams, exit_condition)
